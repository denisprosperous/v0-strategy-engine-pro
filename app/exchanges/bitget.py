...
class BitgetExchange(ExchangeInterface):
    ...
    def __init__(self, api_key: str, secret_key: str, passphrase: str, testnet: bool = False):
        ...
        self.exchange = ccxt.bitget({
            'apiKey': api_key,
            'secret': secret_key,
            'password': passphrase,  # Bitget uses password instead of passphrase
            'sandbox': testnet,
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            raise ConnectionError(f"Failed to connect to Bitget: {e}")
    ...
    async def disconnect(self) -> bool:
        ...
        try:
            ...
            self.is_connected = False
            logger.info("Disconnected from Bitget exchange")
            return True
        except Exception as e:
            logger.error(f"Error disconnecting from Bitget: {e}")
            return False
