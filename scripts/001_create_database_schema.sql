...
-- Run this script to set up the trading system database
...
CREATE INDEX IF NOT EXISTS idx_signals_strategy_symbol ON trade_signals(strategy_id, symbol);

-- Create unique constraints
CREATE UNIQUE INDEX IF NOT EXISTS unique_market_data ON market_data(symbol, timestamp, source);
