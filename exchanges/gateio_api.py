...
class GateioAPI(BaseExchange):
    """Concrete implementation for Gate.io exchange"""
    ...
    def __init__(self, api_key: str, secret_key: str, passphrase: Optional[str] = None):
        ...
        self.exchange = ccxt.gateio({
            ...
            'options': {
                'defaultType': 'spot',  # Can be 'spot', 'margin', 'swap', 'future'
    ...
    def get_liquidation_price(self, symbol: str, side: str, amount: float) -> float:
        # Gate.io provides liquidation price directly
    ...
    def get_loan_info(self, asset: str) -> Dict:
        """Get loan information for margin trading"""
        return self.exchange.fetch_loan_info(asset)

    def get_borrow_rate(self, asset: str) -> float:
        """Get borrow rate for a specific asset"""
        return self.exchange.fetch_borrow_rate(asset)
