...
class OKXAPI(BaseExchange):
    """Concrete implementation for OKX exchange"""
    ...
    def __init__(self, api_key: str, secret_key: str, passphrase: str):
        ...
        self.exchange = ccxt.okx({
            ...
            'options': {
                'defaultType': 'spot',  # Can be 'spot', 'margin', 'swap', 'future', 'option'
    ...
    def get_liquidation_price(self, symbol: str, side: str, amount: float) -> float:
        # OKX provides liquidation price directly
    ...
    def get_margin_mode(self) -> str:
        ...
        return self.exchange.fetch_margin_mode()

    def get_trading_fee(self, symbol: str) -> Dict:
